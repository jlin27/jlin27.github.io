.. note::
    ...
    Click :ref:`here <sphx_glr_download_intermediate_model_parallel_tutorial.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_intermediate_model_parallel_tutorial.py:
...
.. _sphx_glr_download_intermediate_model_parallel_tutorial.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: model_parallel_tutorial.py <model_parallel_tutorial.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: model_parallel_tutorial.ipynb <model_parallel_tutorial.ipynb>`
